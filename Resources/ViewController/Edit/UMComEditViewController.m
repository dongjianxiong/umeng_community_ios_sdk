...
- (int)maxTextLength
{
    return [[UMComSession sharedInstance].maxFeedLength intValue];
}
...
- (void)textViewDidChange:(UITextView *)textView
{
    if ([self isIos7AndLater]) {
        ...
        matchWords = [self updateiOS7AndLaterTextView:textView];
...
- (NSArray *)updateiOS7AndLaterTextView:(UITextView *)textView
{
    ...
    for (NSTextCheckingResult *match in matchs) {
        ...
        NSString *matchText = [textView.textStorage.string substringWithRange:matchRange];
