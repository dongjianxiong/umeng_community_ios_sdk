...
- (void)initTableView
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(forwardFeedFinish:) name:kNotificationForwardFeedResultNotification object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(feedDeletedFinishAction:) name:kUMComFeedDeletedFinishNotification object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(commentOperationFinishAction:) name:kUMComCommentOperationFinishNotification object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(likeOperationFinishAction:) name:kUMComLikeOperationFinishNotification object:nil];
